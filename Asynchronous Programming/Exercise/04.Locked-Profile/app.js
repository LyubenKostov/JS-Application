function lockedProfile() {
    ...
    btnExampleUser.addEventListener('click', () => {
        changeState([radioExample.checked, divExampleUserMoreInfo, btnExampleUser]);
    });
    ...
    (async function () {
        ...
        try {
            ...
            for (let obj of Object.values(data)) {
                ...
                const radioLock = generateEl('input', '', divProfile, {
                    type: 'radio',
                    name: `${obj.username}`,
                    value: 'lock',
                    checked: ''
                ...
                const divHideInfo = generateEl('div', '', divProfile, {
                    id: `${obj.username}HiddenFields`,
                    style: 'display: none;'
                });
                generateEl('hr', '', divHideInfo);
                generateEl('label', 'Email', divHideInfo);
                generateEl('input', '', divHideInfo, {
                    type: 'email',
                    name: `${obj.username}Email`,
                    value: `${obj.email}`,
                    disabled: '',
                    readonly: ''
                });
                ...
                btnShowMore.addEventListener('click', () => {
                    changeState([radioLock.checked, divHideInfo, btnShowMore]);
                });
            }
        } catch (error) {
